...
exports.downloadTikTokVideo = void 0;
const tt_services_1 = require("./tt.services");
const downloadTikTokVideo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { url } = req.body;
    try {
        const fetch = (yield Promise.resolve().then(() => __importStar(require("node-fetch")))).default;
        const response = yield fetch(url);
        const buffer = yield response.buffer();
        const download = yield (0, tt_services_1.createDownloadRecord)(url, "video");
